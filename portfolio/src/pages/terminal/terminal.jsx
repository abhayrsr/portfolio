...
export default function Terminal({toggle}) {
  ...
  return (
    <div>
      <div className="terminal relative md:container md:mx-auto size-full">
        <div className="terminal-content absolute left 0 font-ubuntu text-white mobile:text-xs tablets:text-xl laptop:text-2xl size-full">
