  ...
  return (
    <div>
      <div className="relative sm:container sm:mx-auto size-full">
        <div className="terminal absolute left 0 overflow-hidden whitespace-nowrap font-ubuntu text-white mobile:text-xs tablets:text-xl laptop:text-2xl size-full">
